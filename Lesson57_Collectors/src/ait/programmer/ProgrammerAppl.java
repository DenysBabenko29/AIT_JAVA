...
public class ProgrammerAppl {
    public static void main(String[] args) {
        ...
        printMostSkilledProgrammes(programmers);
    ...
    private static void printMostSkilledProgrammes(List<Programmer> programmers) {
    ...
    private static List<Programmer> getProgrammers() {
        return List.of(
                ...
                new Programmer("Petrovich", "Fortran", "Algol")
        );
    }
}
